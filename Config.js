export const enemyTypes = [
    ...
    { type: "spastic", weight: 15, radius: 5, baseSpeed: 100, baseHealth: 0.3, maxHealth: 50, color: "#E91E63", minLevel: 3, spawnType: "group", attackType: "charge", canDodge: false, accelRate: 5, canDamageWalls: true, groupSettings: { baseGroupSize: 5, growthPerWave: 2.0 } },
