export const enemyTypes = [
    ...
    { type: "spastic", weight: 15, radius: 4, baseSpeed: 130, baseHealth: 0.3, maxHealth: 250, color: "#E91E63", minLevel: 0, spawnType: "group", attackType: "charge", canDodge: false, accelRate: 0.35, canDamageWalls: true, groupSettings: { baseGroupSize: 2, growthPerWave: 1.0 } },
    ...
    { type: "boss", weight: 0, radius: 8, baseSpeed: 20, baseHealth: 50, maxHealth: 15000, color: "#B71C1C", minLevel: 0, spawnType: "single", attackType: "ranged", canDodge: false },
];
