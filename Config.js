...
export const spawnSettings = { baseSpawnDelay: 2500, minSpawnDelay: 300, delayReductionPerWave: 100 };

export const difficultyCurve = { healthMultiplier: 1.2, speedMultiplier: 1.02, rewardMultiplier: 1.15 };
