...
export function broadphaseBoundsFromShape(shape, cx, cy, angle = 0, halfExtents = null) {
    if (shape.type === "Circle") {
        return { kind: "circle", cx, cy, r: shape.radius };
    }
...
export function pairBroadphaseBoundsOverlap(a, b) {
    ...
    if (a.kind === "circle" && b.kind === "obb") {
        return circleObbOverlap(a, b);
    }
    if (a.kind === "obb" && b.kind === "circle") {
        return circleObbOverlap(b, a);
    }
    if (a.kind === "obb" && b.kind === "obb") {
        return obbObbOverlap(a, b);
    }
    return false;
}
