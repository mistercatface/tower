...
export function buildLongAxisBoxMesh(hx, hy, height, facing, rollAngle) {
    ...
    return [...quad(0, 1, 2, 3, "bottom"), ...quad(4, 5, 6, 7, "top"), ...quad(0, 1, 5, 4, "sideA"), ...quad(1, 2, 6, 5, "endB"), ...quad(2, 3, 7, 6, "sideB"), ...quad(3, 0, 4, 7, "endA")];
}
...
export function fallenLongAxisDimsFromStrategy(strategy, baseR) {
    ...
    return { hx: strategy.fallenHalfExtents?.x ?? uprightH * 0.5, hy: strategy.fallenHalfExtents?.y ?? baseR, height: strategy.fallenRollHeight ?? baseR * 2 };
}
/**
 * @param {object} prop
 */
