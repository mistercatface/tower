...
/** Powered laser/tripwire passage edge. */
export function isPassageLaserEdge(edge) {
    return isForcefieldEdge(edge);
}
...
/** Laser passages conduct passage power along the shared vertex graph. */
export function isPassagePowerConductorEdge(edge) {
    return isPassageLaserEdge(edge);
}
