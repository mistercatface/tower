...
export class NavigationController {
    ...
    steerTo(entity, targetX, targetY, profile, flowFieldGrid = null, state = null) {
        ...
        if (this.onSteerComplete) {
            this.onSteerComplete(entity, { navState, plan, dist, settings });
        }
    }

    updateFlowField({ playerX, playerY, playerTargetX = null, playerTargetY = null, previousGridPos = null, recenterThreshold = this.settings.recenterThreshold }) {
