...
function canStepEitherDirection(grid, navTopology, idx, nIdx) {
 ...
 * @property {Int32Array} activePortalPairs
 * @property {Int32Array} activePortalCount
...
function pathSegmentIsDiscontinuousHop(navTopology, fromIdx, toIdx) {
