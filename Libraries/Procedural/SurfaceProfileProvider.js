...
export class SurfaceProfileProvider {
    ...
    constructor({ profiles = {}, defaultProfileId = null } = {}) {
        ...
        this.defaultProfileId = defaultProfileId ?? Object.keys(this.shippedProfiles)[0] ?? null;
    }
    get defaultId() {
    ...
    listKnownIds() {
        return [...new Set([...Object.keys(this.shippedProfiles), ...Object.keys(this.runtimeProfiles)])];
    }
}
...
export function getSurfaceProfileProvider() {
    if (!activeProvider) throw new Error("SurfaceProfileProvider not configured. Call installGameSurfaceProfileProvider() during bootstrap.");
...
export function installSurfaceProfileProvider(source) {
    const provider = source instanceof SurfaceProfileProvider ? source : new SurfaceProfileProvider(source);
