...
export function drawImageTriangle(ctx, img, s0, s1, s2, d0, d1, d2, opts = {}) {
    ...
    let ts0_x = s0.x, ts0_y = s0.y;
    let ts1_x = s1.x, ts1_y = s1.y;
    let ts2_x = s2.x, ts2_y = s2.y;
    ...
    if (denom < 0) {
        const tmp_sx = ts1_x; const tmp_sy = ts1_y;
        ts1_x = ts2_x; ts1_y = ts2_y;
        ts2_x = tmp_sx; ts2_y = tmp_sy;

        const tmp_rx = r1_x; const tmp_ry = r1_y;
        r1_x = r2_x; r1_y = r2_y;
        r2_x = tmp_rx; r2_y = tmp_ry;
...
export function drawImageQuad(ctx, img, sx0, sy0, sx1, sy1, d0, d1, d2, d3, opts = {}) {
    ...
    if (diag13 < diag02) {
        sPoint0.x = sx0; sPoint0.y = sy0;
        sPoint1.x = sx1; sPoint1.y = sy0;
        sPoint2.x = sx0; sPoint2.y = sy1;
        sPoint3.x = sx1; sPoint3.y = sy1;
    ...
    sPoint0.x = sx0; sPoint0.y = sy0;
    sPoint1.x = sx1; sPoint1.y = sy0;
    sPoint2.x = sx1; sPoint2.y = sy1;
    sPoint3.x = sx0; sPoint3.y = sy1;
