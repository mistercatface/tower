...
function isSphereQuadVisible(prop, px, py, verts) {
    ...
    return isPropMeshFaceVisible(prop, px, py, [v00, v01, v11])
        || isPropMeshFaceVisible(prop, px, py, [v00, v11, v10]);
}
...
export function drawSphereTexturePatch(ctx, prop, px, py, img, options = {}) {
    ...
    const rawCells = options.capAngle != null
    ...
    drawTexturedQuadCells(ctx, cells, img, {
        screenBleed: options.screenBleed ?? 0,
        imageSmoothing: options.imageSmoothing ?? true,
    });
}
