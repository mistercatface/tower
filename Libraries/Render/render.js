...
function prepareWallChunkPropTextures(state, eid) {
    ...
    const ready = worldSurfaces._wallChunkReady ? 1 : 0;
    if (entityWallChunkTextureReady[eid] !== ready) entityCachedStaticKey[eid] = 0n;
    entityWallChunkTextureReady[eid] = ready;
}
