...
function prepareWallChunkPropTextures(state, eid) {
    ...
    if (prop) {
        if (prop._wallChunkTextureReady !== ready) entityCachedStaticKey[eid] = 0n;
