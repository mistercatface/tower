...
export function createSandboxController(state, { requestRedraw, getCanvas, clientToWorld, defaultSpawnPropId, behaviors, defaultBehaviorId }) {
    ...
    const controller = {
        ...
        getPortalStampEntranceMode: () => session.getPortalStampEntranceMode(),
        setPortalStampEntranceMode: (mode) => session.setPortalStampEntranceMode(mode),
        ...
        setSelectedPortalEntranceMode: (mode) => session.setSelectedPortalEntranceMode(mode),
        setSelectedPortalAllowedSide: (side) => session.setSelectedPortalAllowedSide(side),
