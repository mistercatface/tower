...
export const defaultStaticPoseDefs = {
    IDLE: {
        ...
        arms: {
            rArm: { base: 0, swaySpeed: 0.75, swayAmp: 0.15 },
            lArm: { base: 0, swaySpeed: 0.75, swayAmp: -0.15 },
            rElbow: -0.2,
            lElbow: -0.2,
        },
    },
    ...
    PISTOL: {
        ...
        arms: {
            lArm: { base: -HALF_PI, swaySpeed: 0.5, swayAmp: -0.05 },
            lElbow: -HALF_PI,
            rArm: { base: 0.1, swaySpeed: 0.5, swayAmp: 0.05 },
            rElbow: -0.1,
        },
    },
    ...
    DUAL_WIELD: {
        ...
        arms: {
            rArm: { base: -HALF_PI, swaySpeed: 0.5, swayAmp: 0.05 },
            rElbow: -HALF_PI,
            lArm: { base: -HALF_PI, swaySpeed: 0.5, swayAmp: -0.05 },
            lElbow: -HALF_PI,
        },
