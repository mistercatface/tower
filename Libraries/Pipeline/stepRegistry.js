 ...
 *   slots?: { name: string, allowedSteps?: string[], required?: boolean, array?: boolean }[],
...
export function registerMotifTypes(registry, motifTypes) {
    for (const [type, meta] of Object.entries(motifTypes)) registry.register({ id: type, label: meta.label ?? type, defaults: meta.defaults ?? { type }, fields: meta.fields ?? [] });
}
