 ...
 */
export function computeCueStickPose({ ballX, ballY, ballRadius, shotNx, shotNy, pullBack = 0, hx = 70, hy = 1.15, height = 2.3, rollAngle = Math.PI / 2 }) {
    ...
    return { x: tipWorldX - tipWorldOffset.x, y: tipWorldY - tipWorldOffset.y, facing, rollAngle, hx, hy, height, pullBack };
}
/**
 ...
 * @returns {object}
 */
export function cueStickPoseToProp(pose, dims = {}) {
    return {
        x: pose.x,
        y: pose.y,
        facing: pose.facing,
