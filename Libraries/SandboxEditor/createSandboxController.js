...
export function createSandboxController(state, { getCanvas, clientToWorld, behaviors }) {
    ...
    const controller = {
        ...
        getSpawnSplittableWidth: () => session.getSpawnSplittableWidth(),
        setSpawnSplittableWidth: (width) => session.setSpawnSplittableWidth(width),
        getSpawnSplittableHeight: () => session.getSpawnSplittableHeight(),
        setSpawnSplittableHeight: (height) => session.setSpawnSplittableHeight(height),
