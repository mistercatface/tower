...
export function runCardinalAStarFlat(startCol, startRow, targetCol, targetRow, navGraph, cols, rows, maxPathLen, searchState) {
    return new FlatGridSearch({ navGraph, cols, rows, searchState }).cardinal(GridPathQuery.fromCells(startCol, startRow, targetCol, targetRow), maxPathLen);
}
export function runLocalAStarFlat(startCol, startRow, targetCol, targetRow, navGraph, cols, rows, maxPathLen, searchState, stepPenaltyLookup = null) {
    return new FlatGridSearch({ navGraph, cols, rows, searchState, stepPenaltyLookup }).local(GridPathQuery.fromCells(startCol, startRow, targetCol, targetRow), maxPathLen);
}
...
export function runAbstractAStarFlat(startIdx, targetIdx, nodeCol, nodeRow, edgeOffsets, edgeTargets, edgeCosts, nodeCount, searchState) {
    const graph = new FlatGraphView({ nodeCol, nodeRow, edgeOffsets, edgeTargets, edgeCosts, nodeCount });
    return new FlatAbstractGraphSearch({ graph, searchState }).run(startIdx, targetIdx);
}
export function runDijkstraFlat(startCol, startRow, targetCol, targetRow, navGraph, cols, rows, maxPathLen, searchState, stepPenaltyLookup = null) {
    return new FlatGridSearch({ navGraph, cols, rows, searchState, stepPenaltyLookup }).dijkstra(GridPathQuery.fromCells(startCol, startRow, targetCol, targetRow), maxPathLen);
}
export function runGreedyBestFirstFlat(startCol, startRow, targetCol, targetRow, navGraph, cols, rows, maxPathLen, searchState, stepPenaltyLookup = null) {
    return new FlatGridSearch({ navGraph, cols, rows, searchState, stepPenaltyLookup }).greedy(GridPathQuery.fromCells(startCol, startRow, targetCol, targetRow), maxPathLen);
}
