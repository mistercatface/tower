...
export function createGameWorldSurfaceSettings(overrides = {}) {
    ...
    return createWorldSurfaceSettings({
        ...
        groundChunkAnimationsOn: overrides.groundChunkAnimationsOn ?? surfaceDefaults.groundChunkAnimationsOn,
        wallAnimationsOn: overrides.wallAnimationsOn ?? surfaceDefaults.wallAnimationsOn,
        animationBakeMaxFrames: overrides.animationBakeMaxFrames ?? surfaceDefaults.animationBakeMaxFrames,
        animationFrameBatchSize: overrides.animationFrameBatchSize ?? surfaceDefaults.animationFrameBatchSize,
