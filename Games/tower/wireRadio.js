...
export const towerRadioRegistry = createRadioRegistry({
    conversations: radioConversations,
    speakers: radioSpeakers,
});
...
export function wireTowerRadio(eventBus, { requestPause, requestResume }) {
    ...
    const view = createRadioDialogView({
        mainCharacterId: "brock",
        getSpeaker: (id) => towerRadioRegistry.getSpeaker(id),
    });
