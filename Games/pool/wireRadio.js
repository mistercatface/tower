...
export const poolRadioRegistry = createRadioRegistry({ conversations: poolConversations, speakers: poolSpeakers });
...
export function wirePoolRadio(eventBus, { requestPause, requestResume }) {
    ...
    const view = createRadioDialogView({ mainCharacterId: "coach", getSpeaker: (id) => poolRadioRegistry.getSpeaker(id) });
