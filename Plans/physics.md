...
| World prop pooling                 | ✅     | 85  | `worldPropPool.js` object cache                 |
...
| Wall segment narrow phase          | ✅     | 85  | `wallResolution.js` & `WallGeometry.js` expanded metrics                  |
| Wall resolver (per active body)    | ✅     | 85  | `WallCollisionResolver.js` + contact normal resolutions                   |
...
Libraries/Spatial/collision/   — broadphase, pairs, kineticBodySlab, SAT, contact, pipeline
  SatCollision.js              — SAT implementation for polygons/circles
  wallResolution.js            — static wall collisions
  WallGeometry.js              — wall contact normal and geometry calculations
Libraries/Props/worldPropPool.js — object pool cache for dynamic dynamic WorldProps
...
_Last updated: Added worldPropPool caching layer, and updated SAT collision, wall geometry and wall resolution contact solver details._
