...
/** @typedef {import("../Render/Inspect/InspectCatalog.js").InspectSubject} InspectSubject */
...
export function toInspectSubject(pickup) {
    return {
        inspectKey: pickup.strategy?.inspectKey ?? null,
        isDead: Boolean(pickup.isDead),
        facing: pickup.facing ?? 0,
        faceLabelVariants: pickup.faceLabelVariants,
    };
}
