...
describe("active kinetic bodies", () => {
    ...
    it("scheduled activation batches island peers on flush", () => {
        ...
        head._linkNeighborEids = new Int32Array([tail._physId]);
        head._linkNeighborEidCount = 1;
        tail._linkNeighborEids = new Int32Array([head._physId]);
        tail._linkNeighborEidCount = 1;
    ...
    it("scheduled activation wakes direct link neighbors only on long chains", () => {
        ...
        head._linkNeighborEids = new Int32Array([mid._physId]);
        head._linkNeighborEidCount = 1;
        mid._linkNeighborEids = new Int32Array([head._physId, tail._physId]);
        mid._linkNeighborEidCount = 2;
        tail._linkNeighborEids = new Int32Array([mid._physId]);
        tail._linkNeighborEidCount = 1;
        head.isSleeping = true;
        mid.isSleeping = true;
        tail.isSleeping = true;
