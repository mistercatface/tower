...
import { gatherKineticContactPairs, resolveKineticContactPassWithPairs, checkPairCollisionAtSlabPose } from "../../Libraries/Physics/physics.js";
import { kineticDynamicSlab } from "../../Core/engineMemory.js";

export function checkPairAtSlabPose(bodyA, bodyB) {
    const slab = kineticDynamicSlab;
    return checkPairCollisionAtSlabPose(bodyA._physId, bodyB._physId, slab.x[bodyA._physId], slab.y[bodyA._physId], slab.x[bodyB._physId], slab.y[bodyB._physId]);
}
