...
import { initSplittableFootprint, splitFootprintIntoComponents } from "../Libraries/Props/splittableWorldProp.js";
describe("poxel fracture", () => {
    ...
    it("splitFootprintIntoComponents forceExplode yields one fragment per poxel", () => {
        const prop = { halfExtents: null, radius: 8, poxels: null, strategy: { splittable: true, collisionShape: "box" } };
