...
import { bakePoxelOutline, buildGeometryFromPoxelParts, splitPoxels } from "../Libraries/Props/props.js";

describe("poxel fracture", () => {
    it("bakes multiple poxels from a box outline", () => {
        const geom = bakePoxelOutline(boxLocalFootprint(8, 8));
    ...
    it("buildGeometryFromPoxelParts produces a polygon collision footprint", () => {
        const crate = bakePoxelOutline(boxLocalFootprint(8, 8));
