...
import { FLOOR_CELL_KIND, isEntityOnFloorBelt, isFloorBeltCell } from "../Libraries/Spatial/grid/FloorCell.js";
...
describe("floor belt on/off cell", () => {
    it("isEntityOnFloorBelt matches body center cell only", () => {
        ...
        assert.equal(isFloorBeltCell(grid, 2 + 2 * grid.cols), true);
        assert.equal(isFloorBeltCell(grid, 0), false);
