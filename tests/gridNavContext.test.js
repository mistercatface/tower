...
describe("grid nav context", () => {
    it("createWorkerNavigation syncs worker arena on onObstaclesChanged", async () => {
        ...
        assert.equal(navigation.syncedNavCacheKey, gridNavCacheKey(grid));
        assert.ok(navigation.isNavTopologySynced());
