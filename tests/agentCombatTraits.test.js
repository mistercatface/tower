...
describe("agentCombatTraits", () => {
    it("snake chain can split and accepts flee escape ram", () => {
        ...
        const traits = getAgentCombatTraits(AGENT_PROFILE.snake);
    ...
    it("flee ball uses flee head ram and escape ram", () => {
        applySnakeGameConfig();
        const traits = getAgentCombatTraits(AGENT_PROFILE.flee);
    ...
    it("squid uses squidVsSquid brain ram and arm prey immunity", () => {
        applySnakeGameConfig();
        const traits = getAgentCombatTraits(AGENT_PROFILE.squid);
    ...
    it("shouldSkipPreyHeadRamKill covers leader draw and squid arm glance", () => {
        applySnakeGameConfig();
        const snake = getAgentCombatTraits(AGENT_PROFILE.snake);
        const squid = getAgentCombatTraits(AGENT_PROFILE.squid);
