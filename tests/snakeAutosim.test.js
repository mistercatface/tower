...
import { resolveSnakeAgentPropContacts, overlapCircleBodies } from "./harness/snakeContactHarness.js";
...
describe("snakeAutosim", () => {
    it("eating a shard removes it and adds a chain segment", () => {
        ...
        chain.head.x = food.x;
        chain.head.y = food.y;
        overlapCircleBodies(chain.head, food);
        chain.head.vx = 1;
        food.vx = -1;
        resolveSnakeAgentPropContacts(state, [chain.head, food]);
