...
function createWallDeleteTestState() {
...
describe("wall delete batching (4a)", () => {
    it("clearGridWallsQuiet removes voxel and rail walls without notifying", () => {
        const state = createWallDeleteTestState();
    ...
    it("deferred commit batches mixed voxel and rail clears into one notify", () => {
        const state = createWallDeleteTestState();
    ...
    it("deferred clearWalls batches voxel and rail in one flush", () => {
        const state = createWallDeleteTestState();
