    ...
    static generateMap(state) {
        ...
        for (let l = 1; l < numLayers; l++) {
            ...
            for (let dir = 0; dir < 8; dir++) {
                ...
                let node = { id: nodeIdCounter++, x: vector.dx * l * xSpacing + jitterX, y: vector.dy * l * layerSpacing + jitterY, connections: [], layer: l };
        ...
        for (let i = 0; i < grid.length; i++) if (Math.random() < 0.45) grid[i] = 1;
                ...
                for (let c = 0; c < cols; c++) {
                    ...
                    for (let dr = -1; dr <= 1; dr++)
                        for (let dc = -1; dc <= 1; dc++) {
                            ...
                            } else wallsCount++; // Borders are solid
                        }
