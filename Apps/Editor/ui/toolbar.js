...
export function bindToolbarControls(handlers) {
    ...
    for (const id of ["showVignetteInput", "showPathDebugInput", "showLosShadowInput", "losShadowVisionTilesInput"]) document.getElementById(id).addEventListener("change", onOverlayChange);
