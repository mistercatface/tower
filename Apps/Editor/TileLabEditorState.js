...
export class TileLabEditorState {
    constructor() {
        ...
        this.railMazeConfig = { ...createDefaultMapGenBoundsConfig(), wallHeightLevel: 1, edgeThickness: 1, corridorWidthMin: 1, corridorWidthMax: 2, extraLinkRatio: 0.25, northReserveRows: 3, surfaceProfileId: "cyberGrid" };
