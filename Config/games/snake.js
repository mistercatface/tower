...
const FLEE_INTENT = {
    reachSlots: {
        ...
        ammo: { targetKey: "ammo", mode: "seek_ammo" },
        food: { targetKey: "food", mode: "seek_food" },
        ally: { targetKey: "ally", mode: "seek_ally" },
    },
    committedSlots: ["food", "enemy", "ammo", "ally"],
    seekModes: ["shoot_enemy", "seek_enemy", "seek_ammo", "seek_food", "seek_ally"],
    huntMode: "seek_enemy",
    fleeHeldOn: "flee",
...
export const SNAKE_GAME_DEFAULTS = {
    ...
    agentCallouts: {
        ...
        duration: 1200,
        yOffset: -14,
        topicCooldownMs: { reloading: 8000, enemy_spotted: 5000, engaging: 4500, following: 6500, getting_ammo: 5000, getting_food: 5000, falling_back: 4500 },
        topics: {
            reloading: { priority: 100, phrases: ["reloading!", "need to reload!", "reloading, cover me!", "empty!", "need ammo!"] },
            ...
            getting_ammo: { priority: 50, phrases: ["getting ammo!", "need bullets!", "resupply!", "ammo run!"] },
