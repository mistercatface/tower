...
const FLEE_INTENT = {
    reachSlots: { threat: { targetKey: "threat", mode: "flee" }, enemy: { targetKey: "prey", mode: "seek_enemy" }, ally: { targetKey: "ally", mode: "seek_ally" } },
    committedSlots: ["enemy", "ally"],
    seekModes: ["shoot_enemy", "seek_enemy", "seek_ally"],
    huntMode: "seek_enemy",
    fleeHeldOn: "flee",
...
export const SNAKE_GAME_DEFAULTS = {
    ...
    agentProfiles: {
        ...
        flee_agent: {
            ...
            stamina: { capacity: 1.0, regenRate: 0.1, drainRate: 0.25 },
            ...
            sprint: {
                ...
                accelMultiplier: 1.5,
                rules: [
                    { mode: "flee", rule: "severeOrLethalThreat", guards: ["hasStamina"], want: true, reason: "escape" },
                    { mode: "seek_enemy", rule: "always", guards: ["hasStamina"], want: true, reason: "attack" },
                ],
            },
            decisionWeights: { flee: 400, shoot_enemy: 460, enemy: 420, seek_ally: 140, explore: 260 },
            factionCohesion: { arrivalRadius: 48, idealStopDist: 2.5, packBonus: 8, satisfiedBonus: 60, fleePackBlend: 0.35, maxPackDistCells: 16 },
            decisionPressure: { outnumberedFleeBonus: 0.4, riskTolerance: { satisfied: 0.35, hungry: 0.35, desperate: 0.35 }, effort: { costPerCell: { satisfied: 18, hungry: 18, desperate: 18 } } },
            targetingHysteresis: { targetStickyFactor: 0.3 },
            decision: {
                scoreOrder: ["flee", "shoot_enemy", "seek_enemy", "seek_ally", "explore"],
                targetLost: { shoot_enemy: "enemy", seek_enemy: "enemy", seek_ally: "ally" },
                remembered: [{ key: "threat" }, { key: "enemy", memoryKey: "prey" }, { key: "ally" }, { key: "allyCount", allyCount: 1 }, { key: "allyCentroid", constant: null }],
                eventTargets: ["threat", "enemy", "ally"],
                slots: { threat: {}, enemy: { visibleFrom: "prey", memoryKey: "prey", hideVisibleWhenMemory: true, known: "visibleOrRemembered" }, ally: { hideVisibleWhenMemory: true } },
                fields: {
                ...
                modes: {
                    ...
                    seek_ally: { scorer: "regroupAlly", slot: "ally", cohesion: "flee", guards: ["noThreat", "allyCloseEnough"] },
                    explore: { scorer: "constant", weightKey: "explore" },
                },
            },
            intent: FLEE_INTENT,
