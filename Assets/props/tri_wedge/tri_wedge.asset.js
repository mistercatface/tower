...
export default {
    id: "tri_wedge",
    primitive: "polygon",
    sandbox: { tags: ["shapes"], behaviors: ["dragLaunch", "grabDrag"], dragLaunch: { minPower: 20, maxPower: 260 }, spawnLabel: "Tri wedge" },
    physics: { isKinetic: true, friction: 8, wallPhysics: { restitution: 0.2, friction: 0.7 }, localFootprint: new Float32Array([-9, -5, 9, -5, 0, 10]) },
