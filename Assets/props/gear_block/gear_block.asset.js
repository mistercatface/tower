...
export default { id: "gear_block", primitive: PROP_PRIMITIVE_POLYGON, sandbox: { tags: ["shapes"], spawnLabel: "Gear block" }, physics: { localFootprint: gearVerts, wallPhysics: { restitution: 0.2, friction: 0.7 } }, visuals: { colors: { ...NEUTRAL_BOX_COLORS }, world: { height: 10 } } };
