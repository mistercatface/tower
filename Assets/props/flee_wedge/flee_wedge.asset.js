...
export default {
    ...
    physics: { isKinetic: true, canChain: true, friction: 8, quantizeSteps: { facing: 8 }, wallPhysics: { restitution: 0.2, friction: 0.7 }, syncCollisionShape: syncFleeHornWedgeCollisionShape },
    visuals: {
