...
export const LEGACY_SCALAR_SYMBOLS = [
    ...
    { pattern: /export function ensureLivePolygonCapacity\s*\(/, label: "bag ensureLivePolygonCapacity", onlyFile: "Libraries/Physics/physics.js" },
